...
const FAQS = [
  {
    ...
    content:
      "Blockchain recycling uses decentralized technology to allow people to earn money by recycling trash items such as plastic, glass, paper, cartons, etc. Your trash is properly collected and handed to recycling companies, who make our environment cleaner and safer for us. You can see exactly where your recyclables go and earn crypto for properly disposing of your trash.",
  },
  {
    title: "How do I earn rewards?",
    content:
      "For every successful recycling activity you complete, you receive a significant of the revenue generated by the recycling businesses that we form partnerships with.",
  },
  {
    title: "How does blockchain improve recycling?",
    content:
      "Beyond allowing the development of a decentralized system for managing trash disposal and management, the blockchain also allows the preservation of your earnings. Earning crypto from your trash incentives good environmental practices that keep our planet clean and healthy.",
  },
  {
    title: "What kind of materials can I recycle?",
    content:
      "At the moment, our platform supports the recycling of materials including plastics, paper, glass and carton. We hope to develop more sustainable models that allow for the recycling of other materials.",
  },
  {
    title: "How do I track my recycling efforts?",
    content:
      "You can monitor your recycling history and impact directly on the platform. You earn from every act of recycling and every withdrawal can be tracked on the Blockchain, allowing for an extra layer of transparency and accountablitiy. We all owe it to the Planet.",
  },
];
